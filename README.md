...
Репозиторий содержит учебный фреймворк для автоматизации UI-тестов ([авторизация](https://the-internet.herokuapp.com/login)) и API-тестов (эндпоинты [сайта](https://restful-api.dev/)) с использованием **Pytest** и **Playwright**.
